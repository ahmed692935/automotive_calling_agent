  ...
  const benefits = [
    {
      ...
      desc: "No more wasting hours on repetitive calls. Suma.ai automates tasks so your team can focus on high-value work.",
    },
    {
      title: "Cut Costs by 70–80%",
      desc: "Eliminate the need for large call center teams—Suma.ai delivers scalable AI-powered calls at a fraction of the cost.",
    },
    {
    ...
    },
    {
      ...
      desc: "Suma.ai never sleeps, ensuring seamless customer engagement anytime, anywhere.",
    },
    {
